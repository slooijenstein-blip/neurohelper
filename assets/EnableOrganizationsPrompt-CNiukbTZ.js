import{o as e,t}from"./react-BqBvWGiZ.js";import{d as n,g as r}from"./react-67B_xmXy.js";import{n as i,r as a,t as o}from"./emotion-react-jsx-runtime.browser.esm-CqUdyvNU.js";import{Q as s,d as c}from"./customizables-L5S4n9zy.js";import{r as l}from"./OptionsContext-DL8RGzIu.js";import{n as u}from"./EnvironmentContext-CJIw9g5H.js";import{t as d}from"./InternalThemeProvider-BBRqdxpX.js";import{t as f}from"./Modal-DKk8qHPl.js";import{t as p}from"./Portal-FpxzsbKb.js";import{i as m,n as h,r as g,t as _}from"./shared-D29MvfVN.js";var v=e(t(),1),y=`https://dashboard.clerk.com/~/organizations-settings`,b=({caller:e,onSuccess:t,onClose:n})=>{let d=r(),[g,_]=(0,v.useState)(!1),[b,x]=(0,v.useState)(!1),[w,D]=(0,v.useState)(null),[O,A]=(0,v.useState)(!1),j=(0,v.useRef)(null),F=u(),I=(0,v.useId)(),L=l(),R=L.__internal_keyless_claimKeylessApplicationUrl,z=L.__internal_keyless_copyInstanceKeysUrl,B=!!R&&!!z,V=F.authConfig.claimedAt!==null,H=b&&B&&!V,U=!e.startsWith(`use`),W=F?.organizationSettings.forceOrganizationSelection!==void 0;return i(p,{children:i(f,{canCloseModal:!1,containerSx:()=>({alignItems:`center`}),initialFocusRef:j,children:a(h,{sx:()=>({display:`flex`,flexDirection:`column`,width:`30rem`,maxWidth:`calc(100vw - 2rem)`}),children:[a(c,{direction:`col`,sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,paddingBottom:e.sizes.$4,gap:e.sizes.$2}),children:[a(c,{as:`header`,align:`center`,sx:e=>({gap:e.sizes.$2}),children:[i(P,{isEnabled:b}),i(`h1`,{css:[m,s`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
