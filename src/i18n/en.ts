export const en = {
  ...
  pro: {
    ...
    back: "Patients",
    forPatient: "{{name}}",
    intro: "Families keep the normal app. They never see this caseload.",
    demoBanner: "Pro demo. Activities, Community, Help, and Profile stay, plus the Pro tab.",
  },
  shared: {
    title: "Shared with you",
    subtitle: "A plan for {{name}}. Your tabs stay the same.",
    shareHelper: "Share with a helper",
    shareTitle: "Share with a grandparent or helper",
    shareBody:
      "They can view this plan and mark steps done. They do not see a clinic caseload, and their app stays the normal caregiver app.",
    namePlaceholder: "Name",
    emailPlaceholder: "Email",
    send: "Send invite",
    sent: "Invite created. They keep the normal app.",
